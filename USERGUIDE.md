...
- **Menu Bar:** On the drop down menu, highlight Special, then select Clear History.
...
- **History Window:** In the History Window, select the item you would like to delete, or highlight multiple items. After items are highlighted click the Remove button on the bottom right hand corner. 
...
- **Menu Bar:** On the drop down menu, click the item you would like to paste.
...
- **Keyboard Shortcut:** <kbd>⌘ Command</kbd> + #
  - The number corresponds to the order of copies.
